...
if grep -Eiq 'click[^[:cntrl:]]*(Hold to reclaim|Review targets|Review this plan|Open Trash|Scan again|Move to SSD|Reveal in Finder|Restore to Mac|Hold to restore|Start review scan|button "Watch"|button "Unwatch")' \
